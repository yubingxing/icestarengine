package com.ice.core.materials {
		...
		* @private
		*/
		public class PerlinMaterial implements fEngineMaterial {
			...
			// Constructor
			public function PerlinMaterial(definition:fMaterialDefinition):void {
			...
			*/
			public function getDiffuse(element:fRenderableElement,width:Number,height:Number):DisplayObject {
				...
				var precision:int = PerlinMaterial.NOISE_PRECISION
