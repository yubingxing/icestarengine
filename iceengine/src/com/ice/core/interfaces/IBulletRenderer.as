...
package com.ice.core.interfaces {
	...
	public interface IBulletRenderer {
		 ...
		 */
		function init(bullet:Bullet):void;
		 ...
		 */
		function update(bullet:Bullet):void;
		 ...
		 */
		function clear(bullet:Bullet):void;
		 ...
		 */
		function getRicochet(element:RenderableElement):MovieClip;
	}
}
